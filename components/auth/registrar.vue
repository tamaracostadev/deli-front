  ...
  <v-container>
    <v-card>
        ...
        <v-card-actions  class="d-flex justify-center">
            ...
            <v-btn class="w-[200px] mx-2" color="primary"  @click="$emit('show-login')">Já tenho uma conta</v-btn>
        </v-card-actions>
    </v-card>
  </v-container>
</template>
...
export default {
    ...
    confirmPasswordRules: [
      ...
      (v) => (v && v.length >= 6 && v === this.password) || 'A confirmação de senha deve ser igual a senha',
    ],
    showPassword: false,
